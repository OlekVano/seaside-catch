    ...
    <div>
      ...
      <div className='px-10 py-20 stained-glass rounded-3xl flex gap-16 mt-32'>
        ...
        <div className='flex-1 flex flex-wrap justify-between align-sub'>
          <img className='object-cover h-[45%] rounded-2xl' src={content!.homepage.welcomeSectionImage1} width='40%' />
          <img className='object-cover h-[45%] rounded-2xl' src={content!.homepage.welcomeSectionImage2} width='55%'/>
          <img className='object-cover h-[45%] rounded-2xl' src={content!.homepage.welcomeSectionImage3} width='55%'/>
          <img className='object-cover h-[45%] rounded-2xl' src={content!.homepage.welcomeSectionImage4} width='40%'/>
        </div>
      </div>
    </div>
  )
