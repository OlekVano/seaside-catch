  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <div className='flex justify-center mt-32 flex-wrap w-full gap-y-14 gap-x-[80px]'>
        <div className='w-[600px] stained-glass rounded-3xl flex p-5 gap-5 cursor-pointer max-md:flex-col max-md:w-full max-md:hover:scale-100 max-md:cursor-auto transition hover:scale-110'>
