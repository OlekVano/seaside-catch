  ...
  return (
    <div>
      ...
      <div className='flex gap-10 mt-32 items-center p-5 max-xl:flex-col-reverse max-xl:gap-20'>
        ...
        <div className='flex-1 flex gap-10 max-xl:w-full max-md:flex-col max-xs:gap-5'>
          <div className='flex-1 flex flex-col gap-10 max-xl:flex-row max-xs:gap-5'>
            <div className='flex flex-col items-center p-5 justify-between flex-1 aspect-square stained-glass rounded-3xl cursor-pointer max-xs:cursor-auto max-xs:hover:scale-100 transition hover:scale-110'>
