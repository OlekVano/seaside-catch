  ...
  return (
    <div>
      ...
      <div className='flex gap-10 mt-32 items-center p-5'>
        <div className='w-7/12 text-body font-semibold text-center drop-shadow-md'>
        ...
        <div className='flex-1 flex gap-10'>
          <div className='flex-1 flex flex-col gap-10'>
            <div className='flex flex-col items-center p-5 justify-between flex-1 aspect-square stained-glass rounded-3xl cursor-pointer transition hover:scale-110'>
              ...
              <div className='text-subheading text-center font-bold drop-shadow-md'>{content!.homepage.chooseUsSectionCard1Title}</div>
            </div>
            <div className='flex flex-col items-center p-5 justify-between flex-1 aspect-square stained-glass rounded-3xl cursor-pointer transition hover:scale-110'>
              <img className='w-1/2 brightness-0 invert' src={content!.homepage.chooseUsSectionCard2Image} />
              <div className='text-subheading text-center font-bold drop-shadow-md'>{content!.homepage.chooseUsSectionCard2Title}</div>
            </div>
          </div>
          <div className='flex-1 flex flex-col gap-10'>
            <div className='flex flex-col items-center p-5 justify-between flex-1 aspect-square stained-glass rounded-3xl cursor-pointer transition hover:scale-110'>
              <img className='w-1/2 brightness-0 invert' src={content!.homepage.chooseUsSectionCard3Image} />
              <div className='text-subheading text-center font-bold drop-shadow-md'>{content!.homepage.chooseUsSectionCard3Title}</div>
            </div>
            <div className='flex flex-col items-center p-5 justify-between flex-1 aspect-square stained-glass rounded-3xl cursor-pointer transition hover:scale-110'>
              <img className='w-1/2 brightness-0 invert' src={content!.homepage.chooseUsSectionCard4Image} />
              <div className='text-subheading text-center font-bold drop-shadow-md'>{content!.homepage.chooseUsSectionCard4Title}</div>
            </div>
          </div>
